...
const main = async () => {
  ...
  const rides = [
    ...
    },
    {
      ...
      name: 'G Force',
      description:
        'Allow your smallest thrill seekers to get a taste of the turns and twirls on these spinning Teacups of fun! Riders must be at least 42" tall to ride alone. ',
      image:
    ...
    },
    {
      ...
      name: 'Last Breathe',
      description:
        'One of the fastest roller coasters in the world and the longest dive coaster, Last Breathe has a 360-degree flip, four inversions and a 75-metre drop. ',
      image:
    ...
    },
    {
      ...
      description:
        'Like the fanciful flight of a whirlwind, the Wheel of Motion spins riders through the sky as they sit suspended from the top of the attraction. This popular family ride creates a delightful feeling of freedom as riders rock in the swinging chair.',
      image:
    ...
    },
    {
      ...
      name: 'Titanic',
      description:
      'This is a classic water boat ride. Board a "Titanic ship" and travel through wavy waters until reaching multiple hills. Up the hill you go to the top, until you crest and head down to a big splash at the bottom, twice! ',
      image:
